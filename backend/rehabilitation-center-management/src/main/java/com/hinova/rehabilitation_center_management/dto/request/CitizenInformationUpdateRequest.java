package com.hinova.rehabilitation_center_management.dto.request;
...
public class CitizenInformationUpdateRequest {
    ...
    @Size(max = 255, message = "Place of birth cannot exceed 255 characters")
    String placeOfBirth;

    @Size(max = 255, message = "Birth registration place cannot exceed 255 characters")
    String birthRegistrationPlace;

    @Size(max = 255, message = "Home town cannot exceed 255 characters")
    String homeTown;
